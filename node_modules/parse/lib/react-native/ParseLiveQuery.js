...
const DefaultLiveQueryController = {
  ...
  /*: Promise<LiveQueryClient>*/
  {
    ...
    const [currentUser, installationId] = await Promise.all([CoreManager.getUserController().currentUserAsync(), CoreManager.getInstallationController().currentInstallationId()]);
